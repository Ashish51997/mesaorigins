...
describe('Dispatch — ready board (API)', () => {
  it('lists a produced order and dispatches it via the API', async () => {
    ...
    await waitFor(() => expect(postIdempotent).toHaveBeenCalledWith('/mesaops/v1/dispatches', expect.objectContaining({ operationalOrderId: 'o1', quantity: '12000', expectedOrderVersion: 2, vehicleNumber: 'KA-09-XY-1111' }), expect.stringMatching(/^dispatch:/)));
  });
});
