...
import { ROLES, RoleName } from '@mesaops/lib/roles';
import { useDirectory, type ApiDirectoryEntry } from '@mesaops/lib/queries/admin';
        ...
        <div className="flex items-center justify-between gap-2 sm:gap-3 mb-6">
          <div className="flex items-center gap-3 min-w-0">
            ...
            <div className="min-w-0">
              <h1 className="font-extrabold text-slate-900 text-base leading-none truncate">MesaOrigins</h1>
