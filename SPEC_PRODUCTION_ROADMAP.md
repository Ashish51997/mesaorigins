...
architecture rationale in [ADR-0002](docs/adr/0002-multi-tenant-saas.md); the Phase-2 logbook
detail in [SPEC_LOGBOOK_PORT.md](SPEC_LOGBOOK_PORT.md).
...
- **Production Log Book**: the full port — see [SPEC_LOGBOOK_PORT.md](SPEC_LOGBOOK_PORT.md).
