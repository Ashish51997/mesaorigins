...
- **UI style guideline:** historical click-dummy notes in
  [ui-style-guide.md](../archive/ui-style-guide.md). **Current product UI** follows
  `.cursor/rules/mesaorigins-design-system.mdc` (Roboto, `#1E40AF` primary).
